...
class AdminProductsControllerCore extends AdminController
{
	...
	public function __construct()
	{
        ...
        if(isset($_POST['productFilter_suppliername'])){
	...
	protected function copyFromPost(&$object, $table)
	{
		...
		if (Tools::getIsset('unit_price') != null)
			$object->price = $object->unit_price = str_replace(',', '.', Tools::getValue('unit_price'));
		...
		if ($this->isTabSubmitted('Prices'))
			$object->on_sale = (int)Tools::getValue('on_sale');
                $object->owner_product = (int)Tools::getValue('owner_product');
                $object->produit_ailleurs = (int)Tools::getValue('produit_ailleurs');
                $object->delay_before_market = (int)Tools::getValue('delay_before_market');
                $object->mp_com = (int)Tools::getValue('mp_com');
                $object->product_type = Tools::getValue('product_type');
	}
