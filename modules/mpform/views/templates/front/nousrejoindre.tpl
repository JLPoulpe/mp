<div id="formulaire" class="container mpborder">
    <div><div class="floatleft"><img src="{$MPURI}/img/paysans_en_paysans.jpg" title="Rejoindre mespaysans.com" /></div><div class="floatleft title">Vous souhaitez rejoindre mespaysans.com</div><div class="clear"></div></div>
    {if empty($ok)}
        <p>
            Rejoindre <span class="mespaysanscom">mespaysans.com</span> c'est :
            <ul>
                <li>L'assurance d'une meilleure visibilité : <span class="mespaysanscom">mespaysans.com</span> met à votre service toute son expertise pour vous assurer la visite d'internaute sur les marchés où vous êtes présent. La préparation d'une fiche informative, décrivant vous et votre activité, permettront aux internautes de mieux vous connaître</li>
                <li>Une augmentation de chiffre d'affaire... sans rien faire : une fois référencé sur le site, vous ne changez pas vos habitudes. Avec <span class="mespaysanscom">mespaysans.com</span>, les clients viendront sur le marchés pour récupérer leur produit. Garder vos habitudes, nous nous chargeons du reste.</li>
        ...
        <form action="{$MPURI}/formulaire/nousrejoindre/" method="post">
            {if isset($err.nom)}
                {if $err.nom=='invalide'}
