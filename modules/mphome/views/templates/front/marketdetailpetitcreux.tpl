<div id="listmarkets" class="mpborder">
    {if $marketDto==null}
        <div class="error">
            <div class="content">Ce marché n'existe pas encore.</div>
        </div>
    {else}
        ...
        <div>
            ...
            {include file="$tpl_dir./mp_detailMarket_petitcreux.tpl"}
            ...
            {if $nbProduct==0}
                <div class="error">
                    <div class="content">Ce marché ne propose pas encore de produits pour vos petits creux.</div>
                </div>
            {else}
