...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
        ...
        <div class="form-group">
		<label class="control-label col-lg-3" for="delay_before_market">
			<span class="label-tooltip" data-toggle="tooltip"
				title="Nombre de jour avant le marché pendant lesquels le produits ne doit pas être affiché. Si 2, le produits disparaitra 2 avant le début du marché">
				{$bullet_common_field} Délai Max avant le marché
			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="12" type="text" id="delay_before_market" name="delay_before_market" value="{$product->delay_before_market|escape:'html':'UTF-8'}" />
		</div>
	</div>
	...
	<div class="form-group">
        ...
        <div class="form-group">
            <div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="product_type" type="default"}</span></div>
            <label class="control-label col-lg-2" for="product_type">
                    Vendre en tant que :
            </label>
            <div class="col-lg-3">
                <select name="product_type" id="product_type">
                    <option value="product" {if $product->product_type == 'product'}selected="selected"{/if} >Produit</option>
                    <option value="basket" {if $product->product_type == 'basket'}selected="selected"{/if} >Panier</option>
                </select>
            </div>
	</div>
		...
		<div class="col-lg-12">
			<div class="form-group">
				<div class="col-lg-1">
					<span class="pull-right">
						{if isset($display_multishop_checkboxes) && $display_multishop_checkboxes}
                            ...
                            {include file="controllers/products/multishop/checkbox.tpl" only_checkbox="true" field="owner_product" type="default"}
                            {include file="controllers/products/multishop/checkbox.tpl" only_checkbox="true" field="produit_ailleurs" type="default"}
						{/if}
					</span>
				</div>
				...
				<div class="col-lg-9">
                    ...
                    <div class="checkbox">
                        <label for="owner_product">
                                <input type="checkbox" name="owner_product" id="owner_product" value="1" {if $product->owner_product}checked="checked"{/if} >
                                Produit appartenant au producteur / artisan</label>
                    </div>
                    <div class="checkbox">
                        <label for="produit_ailleurs">
                                <input type="checkbox" name="produit_ailleurs" id="produit_ailleurs" value="1" {if $product->produit_ailleurs}checked="checked"{/if} >
                                Produit d'ailleurs</label>
                    </div>
                </div>
			</div>
			<div class="form-group">
