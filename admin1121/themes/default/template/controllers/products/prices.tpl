...
<div id="product-prices" class="panel product-tab">
	...
	<div class="form-group">
		...
		<label class="control-label col-lg-2 required" for="wholesale_price">
			<span class="label-tooltip" data-toggle="tooltip" title="Prix TTC fourni par le paysans">Prix Paysans</span>
		</label>
		<div class="col-lg-2">
			<div class="input-group">
				<span class="input-group-addon">{$currency->prefix}{$currency->suffix}</span>
				<input maxlength="27" name="wholesale_price" id="wholesale_price" type="text" value="{{toolsConvertPrice price=$product->wholesale_price}|string_format:$priceDisplayPrecisionFormat}" onchange="javascript:calcPrice(); unitPriceWithTax('unit');" />
			</div>
	...
	<div class="form-group">
		<label class="control-label col-lg-3 required" for="mp_com">
			<span class="label-tooltip" data-toggle="tooltip" title="Saisir la commission définit avec le paysans">
				Commission (%)
			</span>
		</label>
		<div class="col-lg-5">
            <input type="text" id="mp_com" name="mp_com" value="{$product->mp_com}" onchange="javascript:calcPrice(); unitPriceWithTax('unit');" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<label class="control-label col-lg-2" for="unit_price">
			<span class="label-tooltip" data-toggle="tooltip" title="Prix de vente HT mespaysans qui apparaîtra sur le site">Prix unitaire HT</span>
		</label>
		<div class="col-lg-4">
			<div class="input-group">
				<span class="input-group-addon">{$currency->prefix}{$currency->suffix}</span>
