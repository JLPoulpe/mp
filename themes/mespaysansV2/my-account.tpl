    ...
    <div class="col-xs-12 col-sm-8">
        <ul class="myaccount-link-list">
            {if $customer_as_supplier}
                <li><a href="/espace-pro" title="Espace Pro"><i class="icon-desktop"></i><span>Votre espace pro</span></a></li>
                <li><hr /></li>
                <li><b>Votre espace personnel</b></li>
            {/if}
...
<ul class="footer_links clearfix">
    <li><a class="btn btn-default button button-small" href="{$base_dir}" title="{l s='Home'}"><span><i class="icon-chevron-left"></i> {l s='Home'}</span></a>&nbsp;<a class="btn btn-default button button-small right-0" href="{$base_dir}?mylogout" title="Déconnexion"><span><i class="icon-chevron-left"></i>Déconnexion</span></a></li>
</ul>
