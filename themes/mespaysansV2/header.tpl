...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	...
	{if isset($isHP)}
            ...
            <script>(function(d, s, id) {
              ...
              js.src = "//connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v2.5&appId=1551835778437460";
                ...
                <div class="columns-container container">
                    <div id="columns">
                        <div class="row container">
                            ...
                            {/if}
                            {if isset($detailPage) || isset($detailPageProduct)}
                                <div id="detailPage"{if isset($detailPageProduct)} class="detailPageProduct"{/if} >
                                    {if isset($detailPageProduct)}
                                        {$detailPageProduct}
                                    {else}
                                        {$detailPage}
                                    {/if}
                            ...
                            {if isset($left_column_size) && isset($right_column_size)}{assign var='cols' value=(12 - $left_column_size - $right_column_size)}{else}{assign var='cols' value=12}{/if}
                                <div id="center_column{if isset($noRightColumn)}_hp{/if}" class="center_column">
	{/if}
