			...
			<div class="delivery_options_address">
				{if isset($delivery_option_list)}
					...
					{/if}
                                ...
                                {else}
                                    <div class="nogoodcp">Votre adresse de livraison semble être en dehors de notre zone de livraison.<br /><br />
                                    Nous sommes désolé de ne pas pouvoir vous livrer mais n'hésitez pas à vous inscrire à notre newsletter pour être tenue au courant lorsque mespaysans.com arrivera dans votre région.<br /><br />
                                    <a href="/identity#uniform-newsletter">Gérer mon inscription à la newsletter mespaysans.com</a></div>
                                {/if}<!-- end delivery_options_address -->
			...
			{/if}
				...
				<p class="cart_navigation clearfix">
					...
					{/if}
                        ...
                        {/if}
                {/if}
        <input id="customerID" name="customer" value="{$customerId}" type="hidden" />
        <input id="addaddress" value="{$needAddress}" type="hidden" />
        <div id="address_friend">
            <h3>Nouvelle adresse d'un ami ou voisin</h3>
            <div class="personnal-info">
                ...
                <p><label for="mobile">Mobile ** :</label> <input type="text" name="mobile" id="mobile" /></p>
            </div>
            <div class="address-info">
                <p><label for="address">Adresse * :</label> <input type="text" name="address" id="address" /></p>
                <p><label for="address2">Adresse (2) </label> <input type="text" name="address2" id="address2" /></p>
                <p><label for="cp">Code postal * :</label> <input type="text" name="cp" id="cp" /></p>
                <p><label for="city">Ville * :</label> <input type="text" name="city" id="city" /></p>
            </div>
            <p><label for="infos">Informations supplémentaires :</label> <textarea name="infos" id="infos" /></textarea></p>
            <p><label for="addressName">Donnez un titre à cette adresse * :</label> <input type="text" name="addressName" id="addressName" value="Mon voisin" /></p>
            <p class="submit"><input type="button" value="Enregistrer et continuer" /></p>
        </div>
