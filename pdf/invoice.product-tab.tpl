...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<thead>
	<tr>
		<th class="product header small" width="25%">{l s='Product' pdf='true'}</th>
		...
		<th class="product header-right small" width="25%">{l s='Unit Price' pdf='true'}</th>
		<th class="product header small" width="25%">{l s='Qty' pdf='true'}</th>
		<th class="product header small" width="25%">{l s='Total' pdf='true'}</th>
	</tr>
	</thead>
